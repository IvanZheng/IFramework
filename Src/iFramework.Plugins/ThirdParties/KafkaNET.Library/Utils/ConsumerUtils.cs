...
namespace Kafka.Client.Utils
{
    ...
    public static class ConsumerUtils
    {
        ...
        /// </summary>
        /// <remarks>
        ///     If <see cref="offsetRequestConstant" /> not equal to <see cref="OffsetRequest.LatestTime" /> or
        ///     <see cref="OffsetRequest.EarliestTime" /> method returns offset before specified number.
        /// </remarks>
            ...
            long offsetRequestConstant)
        {
            ...
            requestInfos[topic] =
                new List<PartitionOffsetRequestInfo>
                {
                    new PartitionOffsetRequestInfo(partitionId, offsetRequestConstant, 1)
                };
