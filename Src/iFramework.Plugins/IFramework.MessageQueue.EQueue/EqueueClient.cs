...
namespace IFramework.MessageQueue.EQueue
{
    public class EQueueClient : IMessageQueueClient
    {
        ...
        private EQueueConsumer CreateSubscriptionClient(string topic, string subscriptionName,
            OnMessagesReceived onMessagesReceived, string consumerId = null, int fullLoadThreshold = 1000,
        ...
        private EQueueConsumer CreateQueueConsumer(string commandQueueName, string consumerId, int fullLoadThreshold,
            int waitInterval, OnMessagesReceived onMessagesReceived)
        {
