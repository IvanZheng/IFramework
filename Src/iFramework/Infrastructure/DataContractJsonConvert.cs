...
namespace IFramework.Infrastructure
{
    ...
    {
        public string SerializeObject(object value, bool serializeNonPublic = true, bool loopSerialize = false, bool useCamelCase = false, bool ignoreNullValue = false, bool useStringEnumConvert = true)
        {
