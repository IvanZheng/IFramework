...
namespace IFramework.Repositories
{
    public class DomainRepository : IDomainRepository
    {
        ...
        public virtual (IQueryable<TAggregateRoot> data, long total) PageFind<TAggregateRoot>(int pageIndex,
                                                                           int pageSize,
        ...
        public virtual Task<(IQueryable<TAggregateRoot> data, long total)> PageFindAsync<TAggregateRoot>(int pageIndex,
                                                                                      int pageSize,
                                                                                      Expression<Func<TAggregateRoot, bool>> specification,
                                                                                      params OrderExpression[] orderExpressions)
            where TAggregateRoot : class
