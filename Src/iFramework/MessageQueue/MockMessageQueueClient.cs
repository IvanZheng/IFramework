...
namespace IFramework.MessageQueue
{
    public class MockMessageQueueClient : IMessageQueueClient
    {
        ...
        public Task PublishAsync(IMessageContext messageContext,
                                 string topic,
        ...
        public Task SendAsync(IMessageContext messageContext,
                              string queue,
                              CancellationToken cancellationToken)
        {
            return Task.FromResult<object>(null);
        ...
        public IMessageContext WrapMessage(string message,
                                           string type,
                                           string correlationId = null,
                                           string topic = null,
                                           string key = null,
